...
var apps : Array[TabletApp] = [
	...
	TabletApp.new("Flappy Foxy", "Make Foxy jump up and down between the Brick%s brand ovens! Touching the floor or the ovens will cause Foxy to die. painfully." % String.chr(8482), "flappy_foxy", PlaceholderTexture2D.new(), 0.00, store_apps_binary.FLAPPYFOXY),
	TabletApp.new("Chica Pop", "Tap the screen to make her go pop! Try for the biggest number!! My high score is 4", "chica_pop", PlaceholderTexture2D.new(), 0.00, store_apps_binary.CHICAPOP),
	TabletApp.new("Tank Trouble", "Navigate your tank through a simple maze to shoot the opponent's tank! Boy, are these tanks causing some trouble. Wait... say that again...", "tank_trouble", PlaceholderTexture2D.new(), 4.99, store_apps_binary.TANKTROUBLE),
	TabletApp.new("Soccer Physics", "Ever wanted to play soccer, but only being able to kick while jumping? Well, now you can! Beat the enemy team!", "soccer_physics", PlaceholderTexture2D.new(), 4.99, store_apps_binary.SOCCERPHYSICS),
	TabletApp.new("Freddy's Picture Poker", "The classic game where thousands of children learned to gamble. Oh, not from us though. From the folks over at Nintendo.", "poker", PlaceholderTexture2D.new(), 9.99, store_apps_binary.POKER),
	TabletApp.new("Foxy's Paintin' Location", "Turns out, Foxy is quite the artist, and wants to share his art tools with you! Makes sense, I mean, he is a furry after all. You gotta wonder how he can afford so much booty. That, being treasure, you know. (What, is that quote too overdone?)", "drawing", PlaceholderTexture2D.new(), 9.99, store_apps_binary.DRAWING),
	TabletApp.new("Angry Chica", "Those bad piggies have taken Chica's cupcake! (Based on a true story!) Help her get it back! (Unfortunately, not based on the true story.)", "angry_birds", PlaceholderTexture2D.new(), 9.99, store_apps_binary.ANGRYCHICA),
	TabletApp.new("Bonnie's Woods", "Millions of years ago, Bonnie created the concept of trees. (Not really). You play as Stewart, a mouse who wants to get the Cheese from Bonnie, the CEO of Cheese LLC in the year this takes place, 1792.", "warios_woods", PlaceholderTexture2D.new(), 19.99, store_apps_binary.BONNIESWOODS),
