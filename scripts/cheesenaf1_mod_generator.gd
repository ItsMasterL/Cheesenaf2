...
func _create_modpack():
	...
	bbgs.append(berry)
	for bbg in bbgs:
		var file = FileAccess.open(Globals.cheesenaf1_path + "/mods/Cheesenaf2/bbgs/%s/details.json" % bbg.name,FileAccess.WRITE)
		var info = {
			"Name": bbg.name,
		...
		dir.copy_absolute("res://textures/bbgsim/%s/base.png" % bbg.name.to_lower(), Globals.cheesenaf1_path + "/mods/Cheesenaf2/bbgs/%s/base.png" % bbg.name)
		dir.copy_absolute("res://textures/bbgsim/%s/happy.png" % bbg.name.to_lower(), Globals.cheesenaf1_path + "/mods/Cheesenaf2/bbgs/%s/happy.png" % bbg.name)
		dir.copy_absolute("res://textures/bbgsim/%s/neutral.png" % bbg.name.to_lower(), Globals.cheesenaf1_path + "/mods/Cheesenaf2/bbgs/%s/neutral.png" % bbg.name)
		dir.copy_absolute("res://textures/bbgsim/%s/unhappy.png" % bbg.name.to_lower(), Globals.cheesenaf1_path + "/mods/Cheesenaf2/bbgs/%s/unhappy.png" % bbg.name)
		dir.copy_absolute("res://textures/bbgsim/%s/select.png" % bbg.name.to_lower(), Globals.cheesenaf1_path + "/mods/Cheesenaf2/bbgs/%s/select.png" % bbg.name)
